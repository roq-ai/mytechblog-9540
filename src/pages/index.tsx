  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="Welcome to mytechblog - where creative minds and passionate authors come together to share, inspire, and ignite conversations through compelling content."
        />
      </Head>
      <ConfigureCodeBanner
      ...
      <HomeLayout>
        <Box position="relative" display="flex" flex={{ lg: '0 0 485px' }} height={{ base: '180px', lg: 'auto' }}>
          <Image
            flex="1"
            src={
              'https://images.unsplash.com/photo-1499750310107-5fef28a66643?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w0NjA3NjB8MHwxfHNlYXJjaHwxfHxibG9nfGVufDB8fHx8MTY5Mzg5NzIwMnww&ixlib=rb-4.0.3&q=80&w=1080'
            }
            alt="Dinner"
            objectFit="cover"
        ...
        >
          <Box>
            ...
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`Welcome to mytechblog - where creative minds and passionate authors come together to share, inspire, and ignite conversations through compelling content.`}
            </Text>
            <Box
